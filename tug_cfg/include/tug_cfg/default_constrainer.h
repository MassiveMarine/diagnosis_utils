...
protected:
  ...
  template <typename T>
  static void enforceMin(const std::string& name, T& value, const T& min_value);

  template <typename T>
  static void enforceMax(const std::string& name, T& value, const T& max_value);

  template <typename T>
  static void enforceChoices(const std::string& name, T& value,

...
class Actuator:
    ...
    def set_used(self, in_use):
        if in_use == True and self.used == True:
...
class Button(Actuator):
    ...
    """
    def __init__(self, button_id, name='unknown'):
        """
...
class VirtualButton(Actuator):
    ...
    """
    def __init__(self, axis_id, response_at_positive, name='unknown'):
        """
        Constructor of Button derived from Actuator
...
class Axis(Actuator):
    ...
    of the joy-msg.
    """
    def __init__(self, axis_id, name='unknown'):
        """
...
class VirtualAxis(Actuator):
    ...
    """
    def __init__(self, positive_id, negative_id, use_axis, name='unknown'):
        """
        Constructor of Axis derived from Actuator

...
class DefaultMapping:
    ...
    mapping = {
        ...
        # Axis mapping
        AXIS.CROSS_1_AXIS_LEFT:       None,  # Axis(11, 'cross_1_axis_left'),
        AXIS.CROSS_1_AXIS_UP:         None,  # Axis(8,  'cross_1_axis_up'),
        AXIS.CROSS_1_AXIS_DOWN:       None,  # Axis(10, 'cross_1_axis_down'),
        AXIS.CROSS_1_AXIS_RIGHT:      None,  # Axis(9,  'cross_1_axis_right'),
        AXIS.CROSS_1_AXIS_HORIZONTAL: Axis(4,  'cross_1_axis_horizontal'),
        AXIS.CROSS_1_AXIS_VERTICAL:   Axis(5,  'cross_1_axis_vertical'),

        AXIS.CROSS_2_AXIS_LEFT:       None,  # Axis(19, 'cross_2_axis_left'),
        AXIS.CROSS_2_AXIS_UP:         None,  # Axis(16, 'cross_2_axis_up'),
        AXIS.CROSS_2_AXIS_DOWN:       None,  # Axis(18, 'cross_2_axis_down'),
        AXIS.CROSS_2_AXIS_RIGHT:      None,  # Axis(17, 'cross_2_axis_right'),
        ...
        AXIS.SHOULDER_AXIS_LOWER_LEFT:   None,  # Axis(12, 'shoulder_axis_lower_left'),
        AXIS.SHOULDER_AXIS_UPPER_LEFT:   None,  # Axis(14, 'shoulder_axis_upper_left'),
        AXIS.SHOULDER_AXIS_MIDDLE_LEFT:  None,
        AXIS.SHOULDER_AXIS_LOWER_RIGHT:  None,  # Axis(13, 'shoulder_axis_lower_right'),
        AXIS.SHOULDER_AXIS_UPPER_RIGHT:  None,  # Axis(15, 'shoulder_axis_upper_right'),
        AXIS.SHOULDER_AXIS_MIDDLE_RIGHT: None,
